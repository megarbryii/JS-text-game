const textNodes = [
    ...
    },
    {
        ...
        text: 'You are in a room that seems to be covered with a bluish haze as if everything was covered in pale moonlight.  It smells of rain covered rocks.  You see doors to the west, the south, and to the east.',    
        options: [
            {
                text: 'Go west...',
                nextText: 0
